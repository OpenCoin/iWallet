...
@property(readonly)  NSString*  cdd_location; // = "https://mighty-lake-9219.herokuapp.com/gulden/cdds/serial/2342";
...
@property(readonly)  NSString*  issuer_public_master_key;
/*
 =         {
